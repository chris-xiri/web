        ...
        return (
            <div className="min-h-screen bg-xiri-background flex items-center justify-center p-4">
                <div className="bg-white p-8 rounded-2xl shadow-xl text-center max-w-sm w-full border border-slate-100">
                    ...
                    <button onClick={() => setSubmitted(false)} className="w-full bg-slate-900 text-white py-3 rounded-lg font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all">
                        Return to Dashboard
                    </button>
                </div>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right">
                            ...
                            <div className="flex items-center justify-end gap-1.5 text-slate-700 font-bold text-xs">
                                <MapPin size={12} className="text-emerald-500" /> HQ Alpha
                            </div>
                        </div>
                        <LogoutButton />
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
                        ...
                        <div className="px-6 pt-8 pb-6">
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <h3 className="font-black text-lg text-slate-900 tracking-tight">ABC Maintenance Corp</h3>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center mb-3">
                                            <label className="text-[10px] font-black text-slate-700 uppercase tracking-widest flex items-center gap-2">
                                                <Star size={14} className="text-amber-400" /> Quality Assessment
                                            </label>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-black text-slate-700 uppercase tracking-widest flex items-center gap-2">
                                            <MessageSquare size={14} className="text-slate-400" /> Field Observers
                                        </label>
                                        <textarea
                            ...
                            >
                                {submitting ? <RefreshCw className="animate-spin" size={14} /> : (
                                    <>COMMIT AUDIT TO CLOUD <ChevronRight size={14} /></>
                                )}
                            </button>
                        </div>
                    </div>
